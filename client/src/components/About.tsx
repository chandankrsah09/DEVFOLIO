    ...
    <section id="about" className="py-20 relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-glow" data-testid="about-title">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <div className="mt-8">
              <h3 className="text-xl font-semibold text-secondary mb-4" data-testid="technologies-title">
                Technologies I work with:
              </h3>
              <div className="grid grid-cols-2 gap-2 text-sm font-mono">
                {technologies.map((tech, index) => (
                  <div key={index} className="flex items-center" data-testid={`technology-${index}`}>
                    <span className="text-secondary mr-2">▹</span>{tech}
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="relative">
            <div className="glassmorphism rounded-2xl p-6" data-testid="about-image">
              <img 
            ...
            <div className="absolute -bottom-6 -right-6 glassmorphism rounded-xl p-4" data-testid="experience-badge">
